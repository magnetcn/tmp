...
api_key='c1164fab-fcdc-47be-bed0-e1f58392ef9a'
secret_key = "B32E7FED5DE1EAFF37668D7E41CD54CE"
#business
...
def on_open(self):
    ...
    self.send("{'event':'addChannel','channel':'ok_sub_spot_bch_btc_ticker'}") #订阅行情数据
    #self.send("{'event':'addChannel','channel':'ok_sub_spot_X_depth'}")   #订阅现货市场深度(200增量数据返回)
    #self.send("{'event':'addChannel','channel':'ok_sub_spot_X_depth_Y'}") #订阅市场深度
    #self.send("{'event':'addChannel','channel':'ok_sub_futureusd_btc_depth_quarter_20'}")
